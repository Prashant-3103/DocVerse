      ...
      <div className="bg-white shadow-lg rounded-xl p-6 sm:p-8 lg:p-10 max-w-3xl w-full text-center">
        ...
        <ol className="text-left text-gray-700 text-sm sm:text-base space-y-6 mb-8">
          <li className="flex items-start">
            ...
            <p>
              <span className="font-semibold text-blue-600">Upload your documents:</span> Use the <span className="font-semibold text-teal-500">"Upload Files"</span> button to upload PDFs, spreadsheets (CSV, Excel), either directly or via a drive link.
            </p>
          </li>
          <li className="flex items-start">
